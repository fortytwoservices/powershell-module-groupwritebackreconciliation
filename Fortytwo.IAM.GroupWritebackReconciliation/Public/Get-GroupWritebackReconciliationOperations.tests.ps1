        ...
        Mock -ModuleName $Script:Module.Name -CommandName Get-ADGroup -MockWith {
            ...
            $_Groups = @(
                ...
                [PSCustomObject]@{ 
                    ...
                    ObjectSID         = "S-1-5-21-1004336348-1177238915-682003330-513"
                }
                ...
                [PSCustomObject]@{ 
                    ...
                    ObjectSID         = "S-1-5-21-1004336348-1177238915-682003330-514"
                }
                ...
                [PSCustomObject]@{ 
                    ...
                    ObjectSID         = "S-1-5-21-1004336348-1177238915-682003330-515"
                }
                ...
                [PSCustomObject]@{ 
                    ...
                    ObjectSID         = "S-1-5-21-1004336348-1177238915-682003330-516"
                }
            )
